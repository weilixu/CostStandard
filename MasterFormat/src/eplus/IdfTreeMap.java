...
public class IdfTreeMap {
    ...
    // data structures
    private TreeMap<String, TreeMap<String, ArrayList<ValueNode>>> eplusMap;
    ...
    public IdfTreeMap() {
	path = null;
	eplusMap = new TreeMap<String, TreeMap<String, ArrayList<ValueNode>>>();
     ...
     * @param vks
     */
    public IdfTreeMap(String p,
	    TreeMap<String, TreeMap<String, ArrayList<ValueNode>>> map,
	...
	try {
		...
		if (!output && !firstChar.equals(" ")
			...
			eplusMap.put(startToken,
				new TreeMap<String, ArrayList<ValueNode>>());
		    }
	...
	TreeMap<String, ArrayList<ValueNode>> temp = eplusMap.get(objectName);
	...
	// create a new map
	TreeMap<String, ArrayList<ValueNode>> temp = new TreeMap<String, ArrayList<ValueNode>>();
	String elementCount = null;
	if (eplusMap.containsKey(objectName)) {
