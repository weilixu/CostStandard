...
public class CSLRoof extends AbstractMasterFormatComponent implements
BuildingComponent{
    ...
    public CSLRoof() {
	String[] temp = {"NONE:NONE","METAL DECK ROOFS:Membrane, sheathing, insulation board, metal deck",
		"METAL DECK ROOFS:Membrane, sheathing, high insulation board, metal deck",
		"METAL DECK ROOFS:Membrane, sheathing, plus insulation boards, metal deck"};
	...
	if(!walldescription.equals("NONE")){
		try {
			...
			String[] temp = {"NONE:NONE","METAL DECK ROOFS:Membrane, sheathing, insulation board, metal deck",
				"METAL DECK ROOFS:Membrane, sheathing, high insulation board, metal deck",
				"METAL DECK ROOFS:Membrane, sheathing, plus insulation boards, metal deck"};		    
		    if(walldescription.equals("Membrane, sheathing, insulation board, metal deck")){
			materialCost=46.52;
		    }else if(walldescription.equals("Membrane, sheathing, high insulation board, metal deck")){
			materialCost = 58.68;
		    }else if(walldescription.equals("Membrane, sheathing, plus insulation boards, metal deck")){
			materialCost = 71.18;
		    }
	    ...
	    // prepare data for the component cost
	    String[] values = { "CSL-GREENROOF-PAVER", "",
		    "Construction", "CSL-GREENROOF-PAVER", "", "",
		    "142", "", "", "", "", "", "" };
	    String[] description = componentCostDescription.split(":");
	    // add to eplus
	    eplusFile.addNewEnergyPlusObject(componentCostObject, values,
	    ...
	    String[] values2 = { "PROJECT FLAT ROOF", "",
