...
public class UnitaryPanel extends JPanel implements TreeSelectionListener{
    private final static String TAG = "UnitaryHVAC";
    ...
    public UnitaryPanel(EnergyPlusModel m, String unitary){
    ...
    public String getUnitaryName() {
	return unitaryName;
    }
    
    private void disPlayOptions() {
  	statuPanel.removeAll();
  	model.getUnitaryOptionList(unitaryName);
  	model.getUnitaryOptionQuantities(unitaryName);
