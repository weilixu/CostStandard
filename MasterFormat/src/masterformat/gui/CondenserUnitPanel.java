...
public class CondenserUnitPanel extends JPanel implements TreeSelectionListener {

    private final static String TAG = "CONDENSERUNIT";
    ...
    public CondenserUnitPanel(EnergyPlusModel m, String condenser) {
	...
	model.getCondenserUnitOptionList(condenserName);
	model.getCondenserUnitOptionQuantities(condenserName);
