...
public class PumpPanel extends JPanel implements TreeSelectionListener{
    private final static String TAG = "Pump";
    ...
    public PumpPanel(EnergyPlusModel m, String pump){
    ...
    private void disPlayOptions() {
 	...
 	model.getPumpOptionList(pumpName);
 	model.getPumpOptionQuantities(pumpName);
