...
public class ConvectionUnitPanel extends JPanel implements TreeSelectionListener{
    ...
    public ConvectionUnitPanel(EnergyPlusModel m, String unit){
    ...
    private void disPlayOptions() {
  	...
  	model.getConvectionUnitOptionList(unitName);
  	model.getConvectionUnitOptionQuantities(unitName);
