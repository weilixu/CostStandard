...
public class AluminumWindows extends AbstractOpenings {

    private static final String FRAME = "Aluminum";
    ...
    public AluminumWindows() {
	unit = "$/Ea";
	hierarchy = "085113.20 Aluminum Windows";
    }
	...
	try {
	    ...
	    resultSet = statement
		    .executeQuery("select * from openings.windows where frame = '"
			    + FRAME + "' and insulating = '" + insulated + "'");
