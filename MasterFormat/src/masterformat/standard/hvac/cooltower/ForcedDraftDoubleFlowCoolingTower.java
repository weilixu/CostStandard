...
public class ForcedDraftDoubleFlowCoolingTower extends AbstractCoolingTower implements CoolingTower{
    private final String flowType = "Doubleflow";
    private Double capacity;
    
    public ForcedDraftDoubleFlowCoolingTower(){
	unit = "$/TonAC";
