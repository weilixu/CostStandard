...
public class ReciprocatingChiller extends AbstractChiller{
    private Double capacity;
    private final String type = "Reciprocating";
    
    public ReciprocatingChiller(){
	unit = "$/Ea";
	hierarchy = "236419 Reciprocating Chiller";
    }
